...
get_bash() {
  ...
  echo "Copied $HOME/.bash_profile to $dotDirectory/.bash_profile"
  cp $HOME/.bashrc $dotDirectory/.bashrc
  echo "Copied $HOME/.bashrc to $dotDirectory/.bashrc"
}

get_gtk() {
  cp $HOME/.gtkrc-2.0 $dotDirectory/.gtkrc-2.0
  echo "Copied $HOME/.gtkrc-2.0 to $dotDirectory/.gtkrc-2.0"
  cp $HOME/.config/gtk-3.0/settings.ini $dotDirectory/settings.ini
  echo "Copied $HOME/.config/gtk-3.0/settings.ini to $dotDirectory/settings.ini"
}
...
get_panel() {
  ...
  echo "Copied $HOME/.config/xfce4/xfconf/xfce-perchannel-xml/xfce4-panel.xml to $dotDirectory/xfconf/xfce-perchannel-xml/xfce4-panel.xml"
}

# Get xfce4-terminal
get_terminal() {
  cp $HOME/.config/xfce4/terminal/terminalrc $dotDirectory/terminalrc
  echo "Copied $HOME/.config/xfce4/terminal/terminalrc to $dotDirectory/terminalrc"
}
...
get_vscode() {
  ...
  echo "Copied $HOME/.config/Code/User/keybindings.json to $dotDirectory/.config/Code/User/keybindings.json"
  cp $HOME/.config/Code/User/settings.json $dotDirectory/VSCode/settings.json
  echo "Copied $HOME/.config/Code/User/settings.json to $dotDirectory/VSCode/settings.json"
}
...
get_keybinding() {
  ...
  echo "Copied $HOME/.config/xfce4/xfconf/xfce-perchannel-xml/xfce4-keyboard-shortcuts.xml to $dotDirectory/.config/xfce4/xfconf/xfce-perchannel-xml/xfce4-keyboard-shortcuts.xml"
}

get_vim() {
  cp $HOME/.vimrc $dotDirectory/.vimrc
  echo "Copied $HOME/.vimrc to $dotDirectory/.vimrc"
}

get_thunar_usa() {
  cp $HOME/.config/Thunar/uca.xml $dotDirectory/uca.xml
  echo "Copied $HOME/.config/Thunar/uca.xml to $dotDirectory/uca.xml"
}

get_xfce() {
  mkdir -p $dotDirectory/xfconf/xfce-perchannel-xml
  cp $HOME/.config/xfce4/xfconf/xfce-perchannel-xml/xfwm4.xml $dotDirectory/xfconf/xfce-perchannel-xml/xfwm4.xml
  echo "Copied $HOME/.config/xfce4/xfconf/xfce-perchannel-xml/xfwm4.xml to $dotDirectory/xfconf/xfce-perchannel-xml/xfwm4.xml"
  cp $HOME/.config/xfce4/xfconf/xfce-perchannel-xml/xsettings.xml $dotDirectory/xfconf/xfce-perchannel-xml/xsettings.xml
  echo "Copied $HOME/.config/xfce4/xfconf/xfce-perchannel-xml/xsettings.xml to $dotDirectory/xfconf/xfce-perchannel-xml/xsettings.xml"
}

get_xmodmap() {
  cp $HOME/.Xmodmap $dotDirectory/.Xmodmap
  echo "Copied $HOME/.Xmodmap to $dotDirectory/.Xmodmap"
}
